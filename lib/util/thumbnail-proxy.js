...
const {replacementThumbnailPath} = require('../config/thumbnail-proxy')

const unavailableThumbnail = fs.readFileSync(replacementThumbnailPath)
...
function proxyThumbnail(url, req, res) {
